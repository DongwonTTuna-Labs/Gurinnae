...
def validate(root: Path, result: Validation) -> None:
    ...
    expected_volumes={'submission-api':'gurine-objects:/var/lib/gurine-objects','ingest-worker':'gurine-objects:/var/lib/gurine-objects','workflow-worker':'gurine-objects:/var/lib/gurine-objects','document-extractor':'gurine-objects:/var/lib/gurine-objects','notification-worker':'gurine-mail:/var/lib/gurine-mail'}
