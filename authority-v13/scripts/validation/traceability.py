...
def validate(root: Path, result: Validation) -> None:
    ...
    expected={'screens':94,'operations':212,'query_operations':107,'command_operations':105,'http_write_operations':102,'database_tables':107,'database_migrations':24,'roles':15,'capabilities':31,'events':99,'acceptance_scenarios':271,'public_operations':41,'submission_operations':34,'control_operations':131,'identity_operations':6,'commands':105,'queries':107}
