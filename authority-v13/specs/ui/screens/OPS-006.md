...
|---:|---|---|---|---|
| 1 | `active` | 활성 switch | `StructuredContentSection` | scope·reason·expiry. |
| 2 | `catalog` | switch 목록 | `DataCollection` | safe fallback. |
...
| 6 | `runbook` | runbook | `StructuredContentSection` | verification. |
...
|---|---|---|---|---|---|
| `activate` | Kill switch 활성화 | `DESTRUCTIVE_CONFIRMATION` | `STEP_UP` | `kill_switch.execute` | `activateKillSwitch` |
