...
|---:|---|---|---|---|
| 1 | `identity` | run identity | `StructuredContentSection` | trigger·version·time. |
| 2 | `scope` | scope | `StructuredContentSection` | page/time/checkpoint. |
| 3 | `counts` | record flow | `StructuredContentSection` | fetched/new/duplicate/quarantined. |
| 4 | `errors` | 오류 | `StructuredContentSection` | class·sample redaction. |
| 5 | `artifacts` | artifacts | `StructuredContentSection` | log·schema sample·checksum. |
| 6 | `impact` | downstream | `StructuredContentSection` | jobs/rules/public. |
...
| `open-quarantine` | 격리 record 보기 | `NAVIGATION` | `NONE` | `none` | `local-only` |
