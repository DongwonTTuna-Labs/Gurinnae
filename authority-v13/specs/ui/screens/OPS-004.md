...
| 2 | `spend` | 사용량 | `StructuredContentSection` | provider/workload/case bucket. |
| 3 | `forecast` | forecast | `StructuredContentSection` | confidence/assumption. |
| 4 | `limits` | 한도 | `StructuredContentSection` | soft/hard/fallback. |
| 5 | `alerts` | 경고 | `StructuredContentSection` | threshold. |
| 6 | `changes` | 변경 이력 | `RevisionTimeline` | approver/reason. |
