...
|---:|---|---|---|---|
| 1 | `identity` | 기관 identity | `RevisionTimeline` | 공식명·유형·관할·변경 이력. |
| 2 | `coverage` | coverage | `CoverageStatement` | source·기간·누락. |
| 3 | `metrics` | 설명 통계 | `StatusAndRevisionHeader` | 계약 수·금액·상태 분포와 denominator. |
