...
|---:|---|---|---|---|
| 1 | `identity` | 업체 identity | `KnownUnknownResponse` | 공식명·식별·변경 이력·확인 한계. |
| 2 | `coverage` | coverage | `CoverageStatement` | source·기간. |
| 3 | `metrics` | 설명 통계 | `ComparisonWorkbench` | 계약·기관 분포와 denominator. |
