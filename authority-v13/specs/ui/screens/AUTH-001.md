...
Test prefix: `auth_001`

## 사용자 목적

조직 identity provider로 안전하게 로그인하고 원래 작업으로 돌아간다.
...
|---|---|---|---|---|---|
| `sign-in` | 조직 계정으로 로그인 | `COMMAND` | `ANONYMOUS_PROOF` | `none` | `startOidcLogin` |
...
- 앱 자체 비밀번호
- production/staging 혼동

## Implementation files

- Page: `apps/review-console/src/routes/auth/sign-in/+page.svelte`
- Server load/actions: `apps/review-console/src/routes/auth/sign-in/+page.server.ts`
...
- View model: `apps/review-console/src/lib/view-models/auth-001.ts`
- E2E: `tests/e2e/screens/auth-001.spec.ts`
- Visual: `tests/visual/auth-001.spec.ts`
