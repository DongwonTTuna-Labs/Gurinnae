...
|---:|---|---|---|---|
| 1 | `scope` | 목록 범위 | `StatusAndRevisionHeader` | 공개된 revision만 포함함을 설명한다. |
| 2 | `filters` | 필터 | `UnifiedSearch` | 상태·기관 유형·지역·방법론·기간·소명 상태. |
| 3 | `results` | 결과 | `StatusAndRevisionHeader` | 관찰 사실·미확인·상태·freshness를 포함한다. |
...
| `subscribe-filter` | 이 조건 구독 | `COMMAND` | `ANONYMOUS_PROOF` | `none` | `createSubscription` |
