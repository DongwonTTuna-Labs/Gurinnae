...
|---:|---|---|---|---|
| 1 | `identity` | source 설명 | `StructuredContentSection` | owner·접근 방식. |
| 2 | `freshness` | 수집 상태 | `StatusAndRevisionHeader` | last success·lag·incident. |
| 3 | `coverage` | 범위 | `CoverageStatement` | 기간·기관·record. |
| 4 | `schema` | schema | `RevisionTimeline` | 현재 version·변경 이력. |
| 5 | `quality` | known quality | `StructuredContentSection` | 누락·중복·형식. |
...
|---|---|---|---|---|---|
| `view-official` | 공식 source 열기 | `EXTERNAL_LINK` | `NONE` | `none` | `local-only` |
