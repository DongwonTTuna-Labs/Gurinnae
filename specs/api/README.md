...
|---|---:|---|---|---|
| Public API | 43 | 승인된 public projection과 정적 정책 콘텐츠 조회·필터 결과 내려받기 | Public Web, 공개 API 사용자 | `api-client-public` |
...
외부 operation contract 합계는 **217개**다. Private Identity Service 9개 operation은 외부 217개와 분리된 service-assertion API다.

## 권위 파일

- `operation-contracts.yaml`: 외부 217개 operation의 method/path/auth/schema/audit/idempotency
- `public-api.openapi.yaml|json`: 43 operations
