...
|---:|---|---|---|---|
| 1 | `summary` | 수집 범위 요약 | `StatusAndRevisionHeader` | 수집 대상·제외 범위·기준일별 최신 상태. |
| 2 | `sources` | 출처별 범위 | `CoverageStatement` | 기간·기관·갱신. |
| 3 | `gaps` | 알려진 누락 | `StructuredContentSection` | 미수집·누락·license. |
