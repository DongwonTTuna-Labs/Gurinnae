...
|---:|---|---|---|---|
| 1 | `identity` | job identity | `StructuredContentSection` | type·aggregate·created. |
| 2 | `state` | 상태·lease | `StatusAndRevisionHeader` | owner/fencing/heartbeat. |
| 3 | `attempts` | attempt history | `StructuredContentSection` | error/fingerprint/backoff. |
| 4 | `payload` | payload reference | `StructuredContentSection` | redacted. |
| 5 | `effects` | side effects | `StructuredContentSection` | outbox/inbox/projection. |
| 6 | `recovery` | 복구 | `StructuredContentSection` | retry/cancel/quarantine. |
| 7 | `audit` | event | `StructuredContentSection` | commands. |
