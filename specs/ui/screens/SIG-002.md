...
|---:|---|---|---|---|
| 1 | `identity` | 출처·규칙·최신성 | `CoverageStatement` | 입력 version. |
| 2 | `calculation` | 결정적 계산 | `ComparisonWorkbench` | input/formula/result. |
| 3 | `quality` | 차단 요인·품질 | `StructuredContentSection` | unit/VAT/bundle. |
| 4 | `cohort` | 비교군 | `ComparisonWorkbench` | 분포·제외. |
| 5 | `provenance` | 원본 | `EvidenceLedger` | field locator. |
| 6 | `related` | 관련 신호·사건 | `SignalTriagePanel` | duplicate. |
| 7 | `ai` | 인공지능 제안 | `AgentSuggestionPanel` | 보조. |
| 8 | `decision` | 분류 결정 | `DecisionReviewPanel` | reason code. |
