...
|---:|---|---|---|---|
| 1 | `catalog` | 역할 목록 | `StatusAndRevisionHeader` | description/status. |
| 2 | `capabilities` | 권한 행렬 | `StructuredContentSection` | read/write/high impact. |
| 3 | `conflicts` | 직무 분리 | `AccessManagementPanel` | conflicting roles. |
| 4 | `grants` | 권한 부여 현황 | `StructuredContentSection` | count/expiry. |
