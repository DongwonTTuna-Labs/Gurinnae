...
|---:|---|---|---|---|
| 1 | `summary` | 실행 상태 | `OperationsStatusPanel` | success/failure/lag. |
| 2 | `filters` | 필터 | `UnifiedSearch` | status/time/trigger. |
| 3 | `runs` | 실행 목록 | `DataCollection` | records·checkpoint·duration·error. |
| 4 | `schedule` | 실행 일정 | `StructuredContentSection` | next run. |
