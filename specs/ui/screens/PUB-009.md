...
|---:|---|---|---|---|
| 1 | `search` | 업체 검색 | `UnifiedSearch` | 공식·과거 업체명과 영업·식별 상태 파셋. |
| 2 | `results` | 업체 목록 | `DataCollection` | 업체명·영업 상태·식별 한계·자료 범위를 포함한 업체 대장. |
| 3 | `identity-note` | 식별 한계 | `StructuredContentSection` | 미확정 merge를 설명. |
