...
|---:|---|---|---|---|
| 1 | `search` | 기관 검색 | `UnifiedSearch` | 공식·과거 기관명과 기관 유형·관할 파셋. |
| 2 | `results` | 기관 목록 | `DataCollection` | 기관명·유형·관할·자료 범위를 포함한 기관 대장. |
| 3 | `coverage` | 수집 범위 | `CoverageStatement` | 미포함 기관 설명. |
