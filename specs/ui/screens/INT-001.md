...
|---:|---|---|---|---|
| 1 | `critical` | 긴급 blocker | `RevisionAndCorrectionPanel` | publication/correction/security. |
| 2 | `my-work` | 내 작업 | `StructuredContentSection` | due·SLA. |
| 3 | `incidents` | source/ops incident | `OperationsStatusPanel` | 영향. |
| 4 | `queues` | queue health | `KnownUnknownResponse` | review/response/job. |
...
| `open-incident` | incident 보기 | `NAVIGATION` | `NONE` | `none` | `local-only` |
