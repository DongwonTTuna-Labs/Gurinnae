...
|---:|---|---|---|---|
| 1 | `principle` | 정정 정책 | `RevisionAndCorrectionPanel` | 공개 기록의 정정·철회·변경 공개 원칙. |
| 2 | `filters` | 필터 | `UnifiedSearch` | 유형·기간·영향. |
| 3 | `records` | 정정 목록 | `DataCollection` | 대상·변경 요약·이유·공개일을 포함한 정정 대장. |
...
| `subscribe` | 정정 알림 구독 | `NAVIGATION` | `NONE` | `none` | `local-only` |
