...
|---:|---|---|---|---|
| 1 | `incidents` | 진행 중 장애 | `OperationsStatusPanel` | 영향·owner·started. |
| 2 | `services` | 서비스 상태 | `OperationsStatusPanel` | API/web/worker. |
| 3 | `pipelines` | 처리 흐름 | `StructuredContentSection` | ingest/analysis/projection. |
| 4 | `queues` | 작업 대기열·실패 격리함 | `DataCollection` | age/backlog. |
| 5 | `cost` | 비용 | `StructuredContentSection` | budget envelope. |
| 6 | `security` | 보안 | `StructuredContentSection` | kill/break-glass. |
| 7 | `slo` | 서비스 수준 목표 | `StructuredContentSection` | trend·error budget. |
