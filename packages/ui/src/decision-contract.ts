export const DECISION_IDS = ["approve", "request-changes", "reject", "recuse"] as const;
...
export function decisionCode(id: string): string {
  ...
  return id === "approve" ? "APPROVE" : id === "request-changes" ? "CHANGES_REQUIRED" : id === "recuse" ? "RECUSE" : "REJECT";
}
